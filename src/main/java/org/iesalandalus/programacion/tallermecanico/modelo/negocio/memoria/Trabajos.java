...
public class Trabajos implements ITrabajos {
    ...
    private Trabajo getTrabajoAbierto(Vehiculo vehiculo) throws TallerMecanicoExcepcion {
        ...
        List<Trabajo> trabajosVehiculo = new ArrayList<>(get(vehiculo));
    ...
    public Trabajo anadirPrecioMaterial(Trabajo trabajo, float precioMaterial) throws TallerMecanicoExcepcion {
        ...
        if (precioMaterial <= 0) {
            throw new TallerMecanicoExcepcion("El precio del material debe ser positivo");
        }
    ...
    public Trabajo cerrar(Trabajo trabajo, LocalDate fechaFin) throws TallerMecanicoExcepcion {
        ...
        Trabajo trabajoEncontrado = getTrabajoAbierto(trabajo.getVehiculo());
        trabajoEncontrado.setFechaFin(fechaFin);
        return trabajoEncontrado;
    }
